...
- All five major bosses use enlarged mechanical models with metal armor, pistons, joints, reactors, damage marks, and a shared phase-marked boss health bar. Each has three unique special attacks with 1.5 seconds of locked-target warning; attacks pause when frozen and accelerate in later health phases. The city shares one attack controller and health bar across its surviving defense systems.
